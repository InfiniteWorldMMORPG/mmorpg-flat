import { compareVectors2, createUUIDv4, isNullOrUndefined, type Vector2 } from '#modules/Common';
import type { GlobalLocationFlatOutputDTO, GlobalMapOutputDTO } from '../dto';
